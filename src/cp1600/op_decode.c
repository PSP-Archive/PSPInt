...
static const char rcs_id[] UNUSED = "$Id: op_decode.c,v 1.18 2001/02/03 02:34:21 im14u2c Exp $";
...
STATIC  void     dec_impl_1op_a  (instr_t*,cp1600_ins_t*);
STATIC  void     dec_impl_1op_b  (instr_t*,cp1600_ins_t*);
STATIC  void     dec_jump        (instr_t*,cp1600_ins_t*);
STATIC  void     dec_reg_1op     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_gswd        (instr_t*,cp1600_ins_t*);
STATIC  void     dec_nop_sin     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_rot_1op     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_reg_2op     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_cond_br     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_dir_2op     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_ind_2op     (instr_t*,cp1600_ins_t*);
STATIC  void     dec_imm_2op     (instr_t*,cp1600_ins_t*);

STATIC  const op_decode_t dec_decode[] =
{
    dec_impl_1op_a,
    dec_impl_1op_b,
    dec_jump,
 ...
 * ============================================================================
 */
STATIC  void     dec_impl_1op_a  (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_impl_1op_b  (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
    /*  Just look up the execute function in the table.  It's that simple.  */
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_jump        (instr_t *instr, cp1600_ins_t *execute)
{
 ...
 * ============================================================================
 */
STATIC  void     dec_reg_1op     (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_gswd        (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_nop_sin     (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_rot_1op     (instr_t *instr, cp1600_ins_t *execute)
{
    /* -------------------------------------------------------------------- */
 ...
 * ============================================================================
 */
STATIC  void     dec_reg_2op     (instr_t *instr, cp1600_ins_t *execute)
{
 ...
 * ============================================================================
 */
STATIC  void     dec_cond_br     (instr_t *instr, cp1600_ins_t *execute)
{
 ...
 * ============================================================================
 */
STATIC  void     dec_dir_2op     (instr_t *instr, cp1600_ins_t *execute)
{
    uint_32 reg0, imm0;
 ...
 * ============================================================================
 */
STATIC  void     dec_ind_2op     (instr_t *instr, cp1600_ins_t *execute)
{
    uint_32 reg0, reg1;
    uint_32 op;
    uint_32 no_dbd = 0;
...
STATIC  void     dec_imm_2op     (instr_t *instr, cp1600_ins_t *execute)
{
...
instr_t * get_instr (void)
{
    ...
    if (instr_list_head == NULL)
    {
        ...
        instr_list_head = malloc(INSTR_CHUNK * sizeof(instr_list_t));
