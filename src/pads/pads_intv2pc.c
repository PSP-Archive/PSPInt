...
static const char rcs_id[]="$Id: pads.c,v 1.18 1999/10/10 08:44:29 im14u2c Exp $";
...
)
{
    ...
    printf("pads_intv2pc:  INTV2PC on port 0x%.3X mapped to $%.4X-$%.4X\n", 
...
{
    (void)pad; (void)addr; (void)io_base;
